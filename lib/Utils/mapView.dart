...
//  final LatLng _center = const LatLng(45.521563, -122.677433);
  ...
  void _getCurrentLocation() async {
    ...
    final positionCurrent = await Geolocator().getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
    print(positionCurrent);

    setState(() {
      _initialPosition = LatLng(positionCurrent.latitude, positionCurrent.longitude);
