...
class DarkHistoryList extends StatefulWidget {
  ...
  @override
  _DarkHistoryListState createState() => _DarkHistoryListState();
}

class _DarkHistoryListState extends State<DarkHistoryList> {
